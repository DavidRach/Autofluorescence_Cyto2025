...
Plots <- QC_ReferenceLibrary(FluorNameContains = MyPanel, returnPlots=TRUE, NumberDetectors=64, legend=FALSE)

Plots <- Plots[[2]]
FileName <- paste0("ThePlots", ".png")
FinalLocation <- file.path(StorageLocation, FileName)
ggsave(filename = FinalLocation, Plots, dpi = 600, width = 4, height = 3)
